...
- operations: полные формулировки операций, действий, этапов, проверок или процедур; по возможности сохраняй порядок и названия сцен/этапов, если они есть.
- skills: полные формулировки знаний, навыков, компетенций, допусков или требований к исполнителю, если они явно есть в тексте.
- violations: полные формулировки нарушений вместе с категорией, если категория дана в тексте.
- visual_points: визуальные ориентиры и формулировки «что должно быть видно крупно / акцент», если они есть в тексте.
- constraints: явные ограничения; если документ — сценарный/съёмочный план, а не нормативный регламент, укажи это.

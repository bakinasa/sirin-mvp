...
const FALLBACK_SUMMARY_PROMPT = `Ты анализируешь документ по профессии, операции или нормативным требованиям.
...
- выделяй только то, что полезно для диагностики навыков и последующего сценария.

Нужно извлечь:
1. brief_points — 5–10 коротких пунктов: о чем документ, что важно для диагностики;
2. operations — ключевые операции и действия;
        ...
        <div className="mt-3 space-y-3 text-sm text-neutral-700 dark:text-neutral-300">
          <ol className="list-decimal space-y-1.5 pl-5">
            ...
            <li>
              ...
              короткие пункты, операции, навыки, нарушения, визуальные точки, ограничения, термины и цитаты.
            </li>
            <li>
